...
from .modeling_utils import (Conv1D, CONFIG_NAME, WEIGHTS_NAME, PretrainedConfig, PreTrainedModel, prune_conv1d_layer, SequenceSummary,
...
class Attention(nn.Module):
  ...
  def merge_heads(self,x):
    ...
    return x.view(*new_x_shape) #in Temsorflow implem: fct merge_states
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids,position_ids=None, token_type_ids=None, past=None, head_mask=None):
      ...
      positioin_embeds = self.wpe(position_ids)
      ...
      if token_type_ids is not None:
        ...
        token_type_embeds = 0 
      hidden_states = inputs_embeds + positioin_embeds + token_type_embeds
